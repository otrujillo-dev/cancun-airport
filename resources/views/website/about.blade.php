    ...
    <main class="main">        
        ...
        <div class="container main-items">
            ...
            <div class="information">
                <div class="left">
                    @if(app()->getLocale() == "en")
                        <h2>What we do in Punta Cana Airport</h2>
                    ...
                    @else
                        <h2>Lo que hacemos en Punta Cana Airport</h2>
                ...
                <div class="bottom">
                    <div>
                        ...
                        @if(app()->getLocale() == "en")
                            ...
                            <p>At Punta Cana Airport, our clients are at the heart of our success, and we recognize that. To exceed their expectations every time, we understand the importance of delivering unparalleled customer service.</p>
                        @else
                            <h3>Enfoque al Cliente</h3>
                            <p>En Punta Cana Airport, nuestros clientes están en el corazón de nuestro éxito, y lo reconocemos. Para superar sus expectativas en todo momento, entendemos la importancia de ofrecer un servicio al cliente sin igual.</p>
                        @endif
                    </div>
                    <div>
                        ...
                        @if(app()->getLocale() == "en")
                            ...
                            <p>The Punta Cana Airport team is made up of dedicated professionals who are committed to continuous improvement and growth. Even in challenging situations, we always strive to deliver exceptional service to our clients, ensuring that they receive the highest level of care, no matter the circumstances.</p>
                        @else
                            <h3>Profesionalismo</h3>
                            <p>El equipo de Punta Cana Airport está formado por profesionales dedicados que están comprometidos con la mejora continua y el crecimiento. Incluso en situaciones difíciles, siempre nos esforzamos por ofrecer un servicio excepcional a nuestros clientes, asegurando que reciban el más alto nivel de atención, sin importar las circunstancias.</p>
                        @endif
                    </div>
                    <div>
                        ...
                        @if(app()->getLocale() == "en")
                            <h3>Teamwork</h3>
                            <p>People are our greatest asset. At Punta Cana Airport, our team thrives on collaboration and innovation. We believe that our high customer satisfaction is not the result of individual efforts but of the collective strength of our team.</p>
                        @else
                            <h3>Trabajo en equipo</h3>
                            <p>Las personas son nuestro mayor activo. En Punta Cana Airport, nuestro equipo se nutre de la colaboración y la innovación. Creemos que nuestra alta satisfacción del cliente no es el resultado de esfuerzos individuales, sino de la fuerza colectiva de nuestro equipo.</p>
                        @endif
                    </div>
                    <div>
                        ...
                        @if(app()->getLocale() == "en")
                            <h3>Reliability</h3>
                            <p>Trust is built on reliability, and at Punta Cana Airport, being trusted by our clients is essential. Our reliability is reinforced through the unwavering support we provide to our clients and partners every step of the way. Transparency in our actions fosters a trusting relationship that allows us to flourish.</p>
                        @else
                            <h3>Fiabilidad</h3>
                            <p>La confianza se basa en la fiabilidad, y en Punta Cana Airport, la confianza de nuestros clientes es esencial. Nuestra fiabilidad se ve reforzada por el apoyo inquebrantable que ofrecemos a nuestros clientes y socios en cada paso del camino. La transparencia en nuestras acciones fomenta una relación de confianza que nos permite prosperar.</p>
                        @endif
                    </div>
                    <div>
                        ...
                        @if(app()->getLocale() == "en")
                            <h3>Innovation</h3>
                            <p>By leveraging innovative booking technology, we ensure that our service remains at the forefront of the industry. We continuously strive to improve our platform, guaranteeing that Punta Cana Airport remains the ultimate transportation solution in Cabo.</p>
                        @else
                            <h3>Innovación</h3>
                            <p>Al aprovechar la innovadora tecnología de reservas, nos aseguramos de que nuestro servicio se mantenga a la vanguardia del sector. Nos esforzamos continuamente para mejorar nuestra plataforma, garantizando que Punta Cana Airport siga siendo la mejor solución de transporte en Cabo.</p>
                        @endif
                    </div>
                    <div>
